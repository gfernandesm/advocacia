...
- Divórcio judicial e extrajudicial, guarda de filhos, pensão alimentícia e partilha de bens
- Reconhecimento e dissolução de união estável
- Processo de Execução e Liquidação de Sentença
- Interdição e Curatela (decretação e alteração)

Direito Previdenciário (INSS):
- Concessão ou restabelecimento de aposentadoria, auxílio-acidente e pensão por morte
- Benefício de Prestação Continuada (BPC/LOAS)
- Revisão de benefício previdenciário
- Certidão de Tempo de Contribuição (CTC)
- Fase judicial para todos os casos acima quando há indeferimento administrativo

Direito Militar (especialidade diferenciada):
- Cobrança de férias e licença-prêmio em pecúnia
- Anulação de ato administrativo
- Adicional de férias para militares agregados/adidos
- Auxílio invalidez
- Sindicâncias
- Isenção de imposto de renda para militares
- Averbação de tempo de serviço (reformados e ex-militares)
- Adicionais de tempo de serviço, habilitação e reintegração
...
- Telefone: (12) 9.8830-2291
- Email: calberto.fernandes@adv.oabsp.org.br

OBSERVAÇÕES PARA OS AGENTES:
- O escritório atende principalmente pessoas físicas (não empresas)
- Direito Militar é uma especialidade rara — tratar com expertise diferenciada
- Clientes previdenciários frequentemente são idosos ou pessoas em vulnerabilidade — linguagem acessível
- Sempre mencionar que o escritório já possui 8 anos de experiência quando relevante
  `.trim(),
};
